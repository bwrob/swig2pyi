...
bondInstruments: list[ql.RateHelper] = []
bondInstruments.extend(zcHelpers)
bondInstruments.extend(bondsHelpers)
...
depoSwapInstruments: list[ql.RateHelper] = []
depoSwapInstruments.extend(depositHelpers)
depoSwapInstruments.extend(swapHelpers)
