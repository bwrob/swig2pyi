...
from swig2pyi.core.schema import Node, Parm


def test_create_db_and_insert_node() -> None:
    ...
    with Session(engine) as session:
        ...
        method_node = Node(
            ...
            feature_ignore=False,
            is_template=False,
            parms=[Parm(name="x", type="int", idx=0)],
        )
    ...
    with Session(engine) as session:
        ...
        assert result.parent_class_id == class_node_id
